% estash.m: predict ash content by SVM regression model 
clear all; 
...
testdat = cvpartition(n,'Holdout',0.25); % hold out 25% of the data for testing 
indtrain = training(testdat); % training set indices 
indtest = test(testdat); % test set indices 
modl = fitrsvm(X(indtrain,:),Y(indtrain),'Standardize',true); % generate of regression model 
