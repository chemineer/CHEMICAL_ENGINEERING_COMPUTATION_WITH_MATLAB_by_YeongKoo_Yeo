...
cfnet = cascadeforwardnet(10); % one hidden layer with 10 neurons 
cfnet = train(cfnet,x,t); % train the cascade-forward network 
view(cfnet) 
y = cfnet(x); 
perf = perform(cfnet,y,t)  % assess performance  